...
export const CassetteDeck = (props) => {
  const { act, data } = useBackend<CassetteDeckData>();
  ...
  const [selectedAge, setSelectedAge] = useLocalState('cassette_age', 50);
