...
/datum/emote/proc/run_emote(mob/user, params, type_override, intentional = FALSE)
	...
	if(emote_type & EMOTE_RUNECHAT)
		for(var/mob/viewer as anything in viewers(user))
			...
			if(user.runechat_prefs_check(viewer, EMOTE_MESSAGE))
				...
				to_chat(viewer, "<span style='color: [user.chat_color]'><b>[user]</b></span> [span_emote("[msg]")]") // DOPPLER EDIT - Coloured chat names - ORIGINAL: to_chat(viewer, span_emote("<b>[user]</b> [msg]"))
			else if(is_audible && is_visual)
				viewer.show_message(
					"<span style='color: [user.chat_color]'><b>[user]</b></span> [span_emote("[msg]")]", MSG_AUDIBLE,  // DOPPLER EDIT - Coloured chat names - ORIGINAL: span_emote("<b>[user]</b> [msg]"), MSG_AUDIBLE,
					"[span_emote("You see how")] <span style='color: [user.chat_color]'><b>[user]</b></span> [span_emote("[msg]")]", MSG_VISUAL,  // DOPPLER EDIT - Coloured chat names - ORIGINAL: span_emote("You see how <b>[user]</b> [msg]"), MSG_VISUAL,
				)
			else if(is_audible)
				viewer.show_message(span_emote("<span style='color: [user.chat_color]'><b>[user]</b></span> [span_emote("[msg]")]"), MSG_AUDIBLE)  // DOPPLER EDIT - Coloured chat names - ORIGINAL: viewer.show_message(span_emote("<b>[user]</b> [msg]"), MSG_AUDIBLE)
			else if(is_visual)
				viewer.show_message(span_emote("<span style='color: [user.chat_color]'><b>[user]</b></span> [span_emote("[msg]")]"), MSG_VISUAL)  // DOPPLER EDIT - Coloured chat names - ORIGINAL: viewer.show_message(span_emote("<b>[user]</b> [msg]"), MSG_VISUAL)
	...
	// Prioritize audible, and provide a visible message if the user is deaf
		...
		user.audible_message(
			message = msg,
			deaf_message = "[span_emote("You see how")] <span style='color: [user.chat_color]'><b>[user]</b></span> [span_emote("[msg]")]", // DOPPLER EDIT - Coloured chat names - ORIGINAL: deaf_message = span_emote("You see how <b>[user]</b> [msg]"),
			self_message = msg,
	...
	if(hologram)
		if(is_important)
			...
			hologram.audible_message(
				message = msg,
				deaf_message = "[span_emote("You see how")] <span style='color: [user.chat_color]'><b>[user]</b></span> [span_emote("[msg]")]",
				self_message = msg,
