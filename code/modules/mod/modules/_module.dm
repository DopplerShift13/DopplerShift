...
/obj/item/mod/module/anomaly_locked/examine(mob/user)
	. = ..()
	if(!length(accepted_anomalies) || coreless) /// DOPPLER EDIT - Support for anomalock modules without a core - ORIGINAL: if(!length(accepted_anomalies))
		return
	if(core)
...
/obj/item/mod/module/anomaly_locked/on_select()
	if(!core && !coreless) /// DOPPLER EDIT - Support for anomalock modules without a core - ORIGINAL: if(!core)
