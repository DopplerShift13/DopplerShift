...
/datum/species/jelly/proc/Cannibalize_Body(mob/living/carbon/human/H)
	...
	qdel(consumed_limb)
	H.adjust_blood_volume(65 * H.physiology.blood_regen_mod) // DOPPLER EDIT - More forgiving jellypeople blood - ORIGINAL: H.adjust_blood_volume(20 * H.physiology.blood_regen_mod)
