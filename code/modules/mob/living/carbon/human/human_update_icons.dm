...
/mob/living/carbon/human/update_worn_id()
	...
	if(wear_id)
		...
		id_overlay = get_updated_worn_icon(id, ID_LAYER, OFFSET_ID, icon_file, my_chest.worn_id_offset) /// DOPPLER SHIFT EDIT - WAS wear_suit.build_worn_icon(default_layer = BACK_LAYER, default_icon_file = icon_file, override_file = autogen_override ? icon_file : null, humie = src)
...
/mob/living/carbon/human/update_worn_gloves()
	...
	var/mutable_appearance/gloves_overlay = get_updated_worn_icon(glasses, GLOVES_LAYER, OFFSET_GLOVES, icon_file, null) /// DOPPLER SHIFT EDIT - WAS wear_suit.build_worn_icon(default_layer = BACK_LAYER, default_icon_file = icon_file, override_file = autogen_override ? icon_file : null, humie = src)
