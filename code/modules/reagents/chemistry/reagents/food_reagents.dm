...
/datum/reagent/consumable/capsaicin/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick, times_fired)
	...
	switch(current_cycle)
		...
		if(35 to INFINITY)
			heating = 20
	affected_mob.adjust_bodytemperature(heating * TEMPERATURE_DAMAGE_COEFFICIENT * REM * seconds_per_tick, max_temp = BODYTEMP_HEAT_LAVALAND_SAFE - 5) // DOPPLER EDIT - MAKES SPICE NOT KILL LIZARDS - ORIGINAL: affected_mob.adjust_bodytemperature(heating * TEMPERATURE_DAMAGE_COEFFICIENT * REM * seconds_per_tick)
