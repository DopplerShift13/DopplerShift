/proc/generate_underwear_icon(datum/sprite_accessory/accessory, datum/universal_icon/base_icon, color, icon_offset = 0) // DOPPLER EDIT CHANGE : adds icon_offset - Colorable Undershirt/Socks
	...
	final_icon.crop(10, 1, 22, 13+icon_offset)	// DOPPLER EDIT CHANGE : adds icon_offset - Colorable Undershirt/Socks
...
/datum/preference/choiced/undershirt/icon_for(value)
	...
	if (value != "Nude")
		...
		icon_with_undershirt.blend_icon(uni_icon(accessory.icon, accessory.icon_state), ICON_OVERLAY) // DOPPLER EDIT, old code: icon_with_undershirt.blend_icon(uni_icon('icons/mob/clothing/underwear.dmi', accessory.icon_state), ICON_OVERLAY)
