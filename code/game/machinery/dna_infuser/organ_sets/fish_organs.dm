...
/datum/bodypart_overlay/mutant/tail/fish/on_mob_insert(obj/item/organ/parent, mob/living/carbon/receiver)
	...
	if(imprint_on_next_insertion && !receiver.dna.features[feature_key])
		receiver.dna.features[feature_key] = /datum/sprite_accessory/tails/fish/none::name // DOPPLER EDIT, old code: receiver.dna.features[feature_key] = pick(SSaccessories.feature_list[feature_key])
