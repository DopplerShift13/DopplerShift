...
/mob/living/carbon/human/toggle_move_intent()
	...
	if(move_intent == MOVE_INTENT_RUN)
		playsound_local(get_turf(src), 'modular_doppler/sprinting/sound/sprintactivate.ogg', 75, vary = FALSE, pressure_affected = FALSE)
	else
		playsound_local(get_turf(src), 'modular_doppler/sprinting/sound/sprintdeactivate.ogg', 75, vary = FALSE, pressure_affected = FALSE)
