...
/datum/martial_art/mad_dog/activate_style(mob/living/new_holder)
	...
	new_holder.add_stun_absorption(
		...
		examine_message = span_boldwarning("%EFFECT_OWNER_THEYRE bristling with raw determination! It'd take real damage or a stun baton to slow %EFFECT_OWNER_THEM down!")
	)
