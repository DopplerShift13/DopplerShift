...
/datum/reagent/drug/demoneye
	...
	TRAIT_COAGULATING, TRAIT_STUNIMMUNE, TRAIT_GRABRESISTANCE, TRAIT_STRONG_GRABBER, TRAIT_NOCRITOVERLAY, TRAIT_NOGUNS) //Forces users to use melee when they are on this drug
