...
GLOBAL_LIST_INIT(doppler_metal_recipes, list(
	...
	new/datum/stack_recipe("donation box", /obj/structure/closet/crate/donation, 1, time = 3 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_CONTAINERS),
))
