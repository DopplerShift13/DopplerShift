/datum/power/thaumaturge_root/spell_preparation
	...
	desc = "You cast spells by focusing on your spells throughout your sleep. Your spells have a limited amount of charges based upon the total amount of points in the Thaumaturgy path. You can allocate up to 6 charges to these spells\
