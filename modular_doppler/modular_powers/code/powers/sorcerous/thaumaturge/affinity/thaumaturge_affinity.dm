...
Tier 3 Affinity is where you really start dressing magically. The job-specific thaumaturge robes, for example Security's, have this tier of affinity. Usually these robes provide some degree of utility, such as armor. This includes body and head slots. Spell Focuses, such as wands, that can't fit in the backpack but can fit in the belt/suit slot also go here. Most spells will cap out at this requirement.
