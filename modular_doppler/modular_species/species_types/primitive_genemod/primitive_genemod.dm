...
/datum/species/human/genemod/primitive/prepare_human_for_preview(mob/living/carbon/human/human_for_preview)
	...
	human_for_preview.dna.features["ears_colors"][1] = "#e9eff5"
	human_for_preview.dna.features["ears_colors"][2] = "#f5afaf"
	human_for_preview.dna.features["ears_colors"][3] = "#222222"
