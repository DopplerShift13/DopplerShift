...
/datum/species/ramatan/prepare_human_for_preview(mob/living/carbon/human/ramatan_for_preview)
	...
	ramatan_for_preview.dna.features["ears_colors"][1] = "#ffffff"
	ramatan_for_preview.dna.features["ears_colors"][2] = "#dddddd"
	ramatan_for_preview.dna.features[FEATURE_FRILLS] = "Ramatan"
	ramatan_for_preview.dna.features["frills_colors"][1] = "#ccecff"
	ramatan_for_preview.dna.features[FEATURE_SNOUT] = "Ramatan"
	ramatan_for_preview.dna.features["snout_colors"][1] = "#ffffff"
	ramatan_for_preview.dna.features["snout_colors"][2] = "#dddddd"
	ramatan_for_preview.dna.features["snout_colors"][3] = "#9a9b9e"
