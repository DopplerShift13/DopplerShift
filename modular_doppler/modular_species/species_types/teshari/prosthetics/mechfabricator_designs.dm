...
/datum/design/teshari_advanced_l_arm
	...
	build_type = MECHFAB
	build_path = /obj/item/bodypart/arm/left/robot/android/teshari_advanced
	materials = list(
...
/datum/design/teshari_advanced_r_arm
	...
	build_type = MECHFAB
	build_path = /obj/item/bodypart/arm/right/robot/android/teshari_advanced
	materials = list(
		/datum/material/iron = SHEET_MATERIAL_AMOUNT * 9,
		/datum/material/titanium = SHEET_MATERIAL_AMOUNT * 3,
		/datum/material/gold = SHEET_MATERIAL_AMOUNT * 3,
...
/datum/design/teshari_advanced_l_leg
	...
	build_type = MECHFAB
	build_path = /obj/item/bodypart/leg/left/robot/android/teshari_advanced
	materials = list(
		/datum/material/iron = SHEET_MATERIAL_AMOUNT * 9,
		/datum/material/titanium = SHEET_MATERIAL_AMOUNT * 3,
		/datum/material/gold = SHEET_MATERIAL_AMOUNT * 3,
...
/datum/design/teshari_advanced_r_leg
	...
	build_type = MECHFAB
	build_path = /obj/item/bodypart/leg/right/robot/android/teshari_advanced
	materials = list(
		/datum/material/iron = SHEET_MATERIAL_AMOUNT * 9,
		/datum/material/titanium = SHEET_MATERIAL_AMOUNT * 3,
		/datum/material/gold = SHEET_MATERIAL_AMOUNT * 3,
