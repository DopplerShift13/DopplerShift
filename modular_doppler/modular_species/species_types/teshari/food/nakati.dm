...
/obj/item/seeds/nakati
	...
	icon = 'modular_doppler/modular_species/species_types/teshari/icons/hydroponics/seeds.dmi'
	icon_state = "seed-nakati"
	species = "nakati"
	plantname = "Nakati Colony"
	product = /obj/item/food/grown/nakati
	growing_icon = 'modular_doppler/modular_species/species_types/teshari/icons/hydroponics/growing.dmi'
...
/obj/item/food/grown/nakati
	...
	icon = 'modular_doppler/modular_species/species_types/teshari/icons/hydroponics/harvest.dmi'
	icon_state = "nakati"
