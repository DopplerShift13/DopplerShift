...
/obj/item/clothing/suit/hooded/doppler/marsian_overalls
	...
	desc = "A dense network of rubber tubes worm their way through this environment suit, comfort control machinery underneath adding or removing temperature from the wearer's overworked body.\
	A retractile hood has been added and equipped with a breathing tube, with cameras on the outside to ensure the visor can remain thick."
	icon = 'icons/map_icons/clothing/suit/_suit.dmi'
	...
	greyscale_config_worn = /datum/greyscale_config/marsian_overalls_worn
...
/obj/item/clothing/head/hooded/doppler/marsian_overalls_helmet
	...
	greyscale_config_worn = /datum/greyscale_config/marsian_overalls_helmet_worn
	greyscale_colors = "#ffffff#ffffff"
	flags_1 = IS_PLAYER_COLORABLE_1
