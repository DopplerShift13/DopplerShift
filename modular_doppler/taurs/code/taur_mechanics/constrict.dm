...
/obj/structure/serpentine_tail/proc/sync_sprite()
	...
	finished_list += rgb2num("[owner.dna.features["taur_colors"][1]]00")
	finished_list += rgb2num("[owner.dna.features["taur_colors"][2]]00")
	finished_list += rgb2num("[owner.dna.features["taur_colors"][3]]00")
